...
class PostPolicy
{
    ...
    //Permettre l.dmin d'avoir tous les droits sur tous ce qui se trouves dans PostPolicy
    ...
    {
        //Autoriser seul les users qui ont la permission create post à creer des posts
