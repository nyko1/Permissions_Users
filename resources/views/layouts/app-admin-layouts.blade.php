...
<html lang="{{ $page->language ?? 'en' }}">
    <head>
        ...
        {{-- Utilisation de la fonction ASSET pour ne pas perdre la fonction CSS et Javascript a cause des routes dynamics --}}
        ...
        <link href="{{asset('backend/assets/css/plugins.cs')}}s" rel="stylesheet" type="text/css" />
