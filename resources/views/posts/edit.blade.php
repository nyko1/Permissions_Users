                ...
                <div class="table-responsive mb-4">
                    <form method="POST" action="{{route('posts.update',$post ->id)}}">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="title" value="{{$post->title}}" class="form-control" id="title" aria-describedby="Title" placeholder="Title">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="body" class="form-control" id="body" aria-describedby="Body" rows="4" cols="50">{{$post->body}}" </textarea>
